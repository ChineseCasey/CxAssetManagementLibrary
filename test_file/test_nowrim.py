...
class CXAssetLibrary(QWidget):
    def __init__(self, parent=None, face_num=1, face_time=500, title=u'AssetLibrary', color_enable=True, move_enable=True):
    ...
    def __init_ui(self):
        ...
        self._widget_layout.setSpacing(3)
        self._widget_layout.setContentsMargins(5, 5, 6, 5)

        self._title_widget_layout = QHBoxLayout()
        self._title_widget_layout.setSpacing(3)
        self._title_widget_layout.setContentsMargins(1, 0, 0, 0)
        ...
        #self._window_title = QLabel()
        self._window_title = Ui_title_Form()
        self._window_title.setupUi(self)
        # self._window_title.setMinimumWidth(80)
        self._title_icon = QPixmap(Cpath.get_icon_path() +'/title_icon.png')
    ...
    def _user_color_ctrl(self):
        self._color_pb = self._window_title.color_pd_btn#QPushButton(u'换色')
    ...
    #     self._lower_button = QPushButton('-')
    #     self._lower_button.setMaximumSize(32, 30)
    #     self._lower_button.setMinimumSize(32, 30)
    #     self._lower_button.clicked.connect(self.showMinimized)
    #
    #     self._maximized_button = QPushButton(u'□')
    #     self._maximized_button.setMaximumSize(32, 30)
    #     self._maximized_button.setMinimumSize(32, 30)
    #     self._maximized_button.clicked.connect(self._set_window_size)
    #
    #     self._close_button = QPushButton('X')
    #     self._close_button.setMaximumSize(32, 30)
    #     self._close_button.setMinimumSize(32, 30)
    #
    #     self._ctrl_layout.addWidget(self._lower_button)
    #     self._ctrl_layout.addWidget(self._maximized_button)
    #     self._ctrl_layout.addWidget(self._close_button)

    def _set_window_ctrl(self):
        self._lower_button = self._window_title._min_btn #QPushButton('-')
        #self._lower_button.setMaximumSize(32, 30)
        #self._lower_button.setMinimumSize(32, 30)
        self._lower_button.clicked.connect(self.showMinimized)

        self._maximized_button = self._window_title._max_btn#QPushButton(u'□')
        #self._maximized_button.setMaximumSize(32, 30)
        #self._maximized_button.setMinimumSize(32, 30)
        self._maximized_button.clicked.connect(self._set_window_size)

        self._close_button = self._window_title._close_btn#QPushButton('X')
        #self._close_button.setMaximumSize(32, 30)
        #self._close_button.setMinimumSize(32, 30)
